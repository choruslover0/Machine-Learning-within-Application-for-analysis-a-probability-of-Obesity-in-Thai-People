...
PROBABILITY_TIERS = [
    ProbabilityTier(
        key="insufficient_weight",
        label="Insufficient Weight tier",
        lower=0.0,
        upper=0.14,
        explanation="Lowest model risk band. Named after the UCI Insufficient_Weight level; it reflects the model's risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="normal_weight",
        label="Normal Weight tier",
        lower=0.14,
        upper=0.28,
        explanation="Low model risk band. Named after the UCI Normal_Weight level; it reflects the model's risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="overweight_level_i",
        label="Overweight Level I tier",
        lower=0.28,
        upper=0.43,
        explanation="Below-middle model risk band. Named after the UCI Overweight_Level_I level; it reflects risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="overweight_level_ii",
        label="Overweight Level II tier",
        lower=0.43,
        upper=0.57,
        explanation="Middle model risk band that deserves closer habit review. Named after the UCI Overweight_Level_II level; it reflects risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="obesity_type_i",
        label="Obesity Type I tier",
        lower=0.57,
        upper=0.71,
        explanation="Above-middle model risk band. Named after the UCI Obesity_Type_I level; it reflects risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="obesity_type_ii",
        label="Obesity Type II tier",
        lower=0.71,
        upper=0.86,
        explanation="High model risk band. Named after the UCI Obesity_Type_II level; it reflects risk probability, not a measured weight class.",
    ),
    ProbabilityTier(
        key="obesity_type_iii",
        label="Obesity Type III tier",
        lower=0.86,
        upper=1.01,
        explanation="Highest model risk band. Named after the UCI Obesity_Type_III level; it reflects risk probability, not a measured weight class.",
    ),
]
